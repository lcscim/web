...
class Customer(models.Model):
    ...
    consult_from=models.ForeignKey("Course",verbose_name="咨询课程",on_delete=models.CASCADE)
...
class CourseRecord(models.Model):
    ...
    homework_titlt=models.CharField(max_length=128,blank=True,null=True)
...
class Enrollment(models.Model):
    '''报名表'''
    customer=models.ForeignKey("Customer",on_delete=models.CASCADE)
    enrolled_class=models.ForeignKey("ClassList",on_delete=models.CASCADE,verbose_name="班级列表")
    consultant=models.ForeignKey("UserProfile",verbose_name="课程顾问",on_delete=models.CASCADE)
    contract_agreed=models.BooleanField(default=False,verbose_name="学校已同意合同条款")
